...
output single/double edge mode control."]
    #[inline(always)]
    #[must_use]
    pub fn pwmsel2(&mut self) -> Pwmsel2W<CrSpec> {
        Pwmsel2W::new(self, 2)
    }
    #[doc = "Bit 3 - PWM\\[3\\]
output edge control."]
    #[inline(always)]
    #[must_use]
    pub fn pwmsel3(&mut self) -> Pwmsel3W<CrSpec> {
        Pwmsel3W::new(self, 3)
    }
    #[doc = "Bit 4 - PWM\\[4\\]
output edge control."]
    #[inline(always)]
    #[must_use]
    pub fn pwmsel4(&mut self) -> Pwmsel4W<CrSpec> {
        Pwmsel4W::new(self, 4)
    }
    #[doc = "Bit 5 - PWM\\[5\\]
output edge control."]
    #[inline(always)]
    #[must_use]
    pub fn pwmsel5(&mut self) -> Pwmsel5W<CrSpec> {
        Pwmsel5W::new(self, 5)
    }
    #[doc = "Bit 6 - PWM\\[6\\]
output edge control."]
    #[inline(always)]
    #[must_use]
    pub fn pwmsel6(&mut self) -> Pwmsel6W<CrSpec> {
        Pwmsel6W::new(self, 6)
    }
    #[doc = "Bit 9 - PWM\\[1\\]
output enable control."]
    #[inline(always)]
    #[must_use]
    pub fn pwmena1(&mut self) -> Pwmena1W<CrSpec> {
        Pwmena1W::new(self, 9)
    }
    #[doc = "Bit 10 - PWM\\[2\\]
output enable control."]
    #[inline(always)]
    #[must_use]
    pub fn pwmena2(&mut self) -> Pwmena2W<CrSpec> {
...
output enable control."]
    #[inline(always)]
    #[must_use]
    pub fn pwmena3(&mut self) -> Pwmena3W<CrSpec> {
...
output enable control."]
    #[inline(always)]
    #[must_use]
    pub fn pwmena4(&mut self) -> Pwmena4W<CrSpec> {
...
output enable control."]
    #[inline(always)]
    #[must_use]
    pub fn pwmena5(&mut self) -> Pwmena5W<CrSpec> {
...
output enable control. See PWMENA1 for details."]
    #[inline(always)]
    #[must_use]
    pub fn pwmena6(&mut self) -> Pwmena6W<CrSpec> {
