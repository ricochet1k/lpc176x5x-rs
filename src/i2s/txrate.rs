...
pub type R = crate::R<TxrateSpec>;
#[doc = "Register `TXRATE` writer"]
pub type W = crate::W<TxrateSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn y_divider(&mut self) -> YDividerW<TxrateSpec> {
        YDividerW::new(self, 0)
    }
    #[doc = "Bits 8:15 - I2S transmit MCLK rate numerator. This value is used to multiply PCLK by to produce the transmit MCLK. A value of 0 stops the clock. Eight bits of fractional divide supports a wide range of possibilities. Note: the resulting ratio X/Y is divided by 2."]
    #[inline(always)]
    #[must_use]
    pub fn x_divider(&mut self) -> XDividerW<TxrateSpec> {
        XDividerW::new(self, 8)
    }
}
#[doc = "I2S Transmit MCLK divider. This register determines the I2S TX MCLK rate by specifying the value to divide PCLK by in order to produce MCLK.\n\nYou can [`read`](crate::Reg::read) this register and get [`txrate::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`txrate::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TxrateSpec;
impl crate::RegisterSpec for TxrateSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`txrate::R`](R) reader structure"]
impl crate::Readable for TxrateSpec {}
#[doc = "`write(|w| ..)` method takes [`txrate::W`](W) writer structure"]
impl crate::Writable for TxrateSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TXRATE to value 0"]
impl crate::Resettable for TxrateSpec {
