...
pub type R = crate::R<Fcanic0Spec>;
#[doc = "Register `FCANIC0` writer"]
pub type W = crate::W<Fcanic0Spec>;
...
pub type IntpndR = crate::FieldReader<u32>;
...
pub type IntpndW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn intpnd(&mut self) -> IntpndW<Fcanic0Spec> {
        IntpndW::new(self, 0)
    }
}
#[doc = "FullCAN interrupt and capture register0\n\nYou can [`read`](crate::Reg::read) this register and get [`fcanic0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fcanic0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Fcanic0Spec;
impl crate::RegisterSpec for Fcanic0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fcanic0::R`](R) reader structure"]
impl crate::Readable for Fcanic0Spec {}
#[doc = "`write(|w| ..)` method takes [`fcanic0::W`](W) writer structure"]
impl crate::Writable for Fcanic0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FCANIC0 to value 0"]
impl crate::Resettable for Fcanic0Spec {
